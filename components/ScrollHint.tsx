...
export const ScrollHint = () => {
    ...
    return (
        <div className="absolute top-20 -left-6 md:-left-44 z-50 animate-bounce-horizontal hidden md:block">
            <div className="relative bg-blue-600 text-white px-6 py-3 rounded-full shadow-xl flex items-center gap-3">
                <span className="font-bold whitespace-nowrap">Starta din jämförelse här</span>
                <MoveRight className="w-5 h-5" />

                {/* Speech bubble triangle */}
                <div className="absolute top-1/2 -right-2 w-4 h-4 bg-blue-600 transform -translate-y-1/2 rotate-45" />
            </div>
        </div>
    );
};
